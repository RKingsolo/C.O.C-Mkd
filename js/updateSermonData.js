// Default sermon data for the Church of Christ website
// This file contains the seed data used to populate sermons when no static DOM cards are present
...
export const defaultSermonsData = [
   {
     ...
     },   
    {
        ...
        date: "2025-11-02",
        duration: 40,
        description: "<p>Obedience To God Does Not Have Duplicate But A One Way Order; And While We Struggle And Try To Obey God, It Is Born Out Humility For Honor God Possess. \n It Is Not Because It Is Just Necessary But Because It Important.</p>",
        thumbnailUrl: "src/Documents/NOV,25/sunday/2ND/REBELLION.jpg",
        pdfUrl: "src/Documents/NOV,25/sunday/2ND/REBELLION.pdf"
    },
    {
        title: "MY ROLE TO CHURCH GROWTH",
        preacher: "BRO. FESTUS EJIMADU (Shepherd)",
        date: "2025-11-02",
        duration: 30,
        description: " In  the  first  century,  the  Apostles  were  blessed  with different  gifts  including  miraculous  ones,  these  gifts  were  put together for the church growth. <strong><i><p>Today what is your gift, and how do you use it to the growth of the church?</p></i></strong>",
        thumbnailUrl: "src/Documents/NOV,25/sunday/2ND/My Role To Church Growth.jpg",
        pdfUrl: "src/Documents/NOV,25/sunday/2ND/MY ROLE TO CHURCH GROWTH.pdf"
    },
    {
        title: "FRIENDSHIP AND LOVE",
        preacher: "BRO. ONUH JAMES",
        date: "2025-11-09",
        duration: 30,
        description: "Friendship is too holy to let loose words, reckless moments destroy it... Especially between brethren in Christ; whose love is to be a mark of true discipleship -<strong> Jn 13:35 </strong>",
        thumbnailUrl: "src/Documents/NOV,25/sunday/9TH/Friendship and Love.jpg",
        pdfUrl: "src/Documents/NOV,25/sunday/9TH/FRIENDSHIP AND LOVE.pdf"
    },
    {
        title: "A PRISONER OF JESUS CHRIST",
        preacher: "BRO. ICHA INNOCENT (Minister)",
        date: "2025-11-09",
        duration: 40,
        description: "Do you accept being a prisoner of Christ? Live  like  one,  but  if  not,  serve  your  master  the  devil, because he is lousy and carefree. Everything is permissible or allowed with him. \n <p> With us everything is lawful but not everything is permissible. <strong> 1 Cor. 6:12; 10:23; Galatians 2:20 </strong> </p>",    
        thumbnailUrl: "src/Documents/NOV,25/sunday/9TH/A Prisoner of Jesus Christ.jpg",
        pdfUrl: "src/Documents/NOV,25/sunday/9TH/PRISONER OF CHRIST.pdf"
    }, 
    {
